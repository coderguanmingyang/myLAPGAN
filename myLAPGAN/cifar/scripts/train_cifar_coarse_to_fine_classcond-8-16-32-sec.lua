...
adversarial8 = require 'train.double_conditional_adversarial-8-sec'

network8 = require 'network.network8-sec'
...
criterion8  = nn.ClassNLLCriterion()
...
--[[
model_G8:get(7).weight:normal(0, 0.02)
model_G8:get(7).bias:normal(0, 0.02)
model_G8:get(9).weight:normal(0, 0.02)
model_G8:get(7).bias:normal(0, 0.02)
]]--
epoch = epoch or 1
