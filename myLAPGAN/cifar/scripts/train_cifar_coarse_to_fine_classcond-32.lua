...
adversarial = require 'train.double_conditional_adversarial-32'
...
if opt.network == '' then
  ...
  class1 = nn.Linear(opt.condDim1, opt.condDim2[2]*opt.condDim2[3])(g_c1) -- 10 inputs -> fine size * fine size outputs (default 32)
  ...
  g2 = nn.SpatialConvolutionUpsample(5, nplanes, 7, 7, 1)(g1)   --filter nplanes*7*7
  ...
  model_G = nn.gModule({x_n, g_c1, g_c2}, {g4}) --生成一个有向无环图
...
-- print networks
pa_D = model_D:parameters()
pa_G = model_G:parameters()


print('\n'..'**********[Discriminator network]**********')
print('[Parameters:]')
print(pa_D)
print('size: ' .. model_D:size())
for i=1,model_D:size() do
  print(i,model_D:get(i))
end
print('\n'..'**************[Generator network]**********')
print('[Parameters:]')
print(pa_G)
print('size: ' .. model_G:size())
for i=1,model_G:size() do
  print(i,model_G:get(i))
end
--[[
model_D:get(9).weight[1][1][1][1]=1
print(model_D:get(9).weight[1])
print(pa_D[3][1])
print(model_D:get(9).weight[2])
print(pa_D[3][2])
print(model_D:get(9).bias)
print(pa_D[4])
]]--
...
trainData = cifar.loadTrainSet(1, ntrain) -- start = 1 stop = 45000
